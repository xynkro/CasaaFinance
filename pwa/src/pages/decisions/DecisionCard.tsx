/**
 * decisions/DecisionCard.tsx — the per-decision card and its tightly-coupled
 * sub-pieces (accumulation plan, options spec, copy/IBKR actions, age chip,
 * live-price overlay, TV consensus chip) plus the current-price resolver.
 *
 * Split verbatim out of the original monolithic ``DecisionsPage.tsx`` — behavior
 * and visual output are unchanged. Reuses the ui/ primitives (ConvictionDots,
 * StatusPill, resolveStatus) that the page already standardised on.
 */
...
import { OPTIONS_STRATEGIES, fmtMoney, fmtMoneyMantissa, fmtPct } from "./format";
